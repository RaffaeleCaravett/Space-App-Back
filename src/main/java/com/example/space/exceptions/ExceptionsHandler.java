...
import com.example.space.payloads.errors.ErrorsDTO;
import com.example.space.payloads.errors.ErrorsWithListDTO;
...
public class ExceptionsHandler {
    ...
    public ErrorsWithListDTO handleBadRequest(BadRequestException e) {
        if (e.getMessageList() != null) {
            List<String> errorsList = e.getMessageList().stream().map(objectError -> objectError.getDefaultMessage()).toList();
